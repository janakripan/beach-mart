...
export default function OfferSection() {
  return (
    <section className="w-full flex justify-center bg-white py-6 lg:py-12">
      <div className="w-full max-w-[1440px] flex flex-col gap-[24px] px-0.5 xs:px-1 sm:px-1 md:px-4 lg:px-[72px]">
        {/* Offer Banner */}
        ...
        {/* Item Cards Section */}
        <div className="w-full max-w-6xl bg-[#E4FFEB] rounded-[32px] lg:rounded-[56px] border-b border-[#F1F5F9] py-4 px-0 xs:px-2 md:py-6 md:px-4 lg:pt-[32px] lg:pr-[32px] lg:pb-[32px] lg:pl-[32px] mx-auto">
