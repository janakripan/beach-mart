    ...
    >
      ...
      >
        ...
        >
          ...
          <h2
            className={`text-[#1A1A2E] font-bold whitespace-nowrap text-[22px] transition-all ${
        ...
        <button
          className={`w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-gray-50 ${
